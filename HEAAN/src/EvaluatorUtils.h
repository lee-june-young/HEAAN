...
public:
	...
	static std::complex<double>** generateRandomRealArrays(long n, int user_num);

	static std::complex<double>* generateRandomIntValues(int user_num, int min = -5, int max = 5);

	static std::complex<double>* generateRandomAlphaValues(int user_num, int min, int max);

	static std::complex<double>** generateFLArrays(long n, int user_num);

	static std::complex<double>* generateRandomRealValues(int user_num, double min= 0.0, double max= 1.0);
